...
public class AluguelController {
    ...
    @Operation(summary = "Listar alugueis atrasados")
    ...
    @PostMapping
    @Operation(summary = "Cadastrar alugueis")
    ...
    @Operation(summary =  "Registrar pagamento de aluguel")
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Remover aluguel por id")
